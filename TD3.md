...
git --version
Output : git version 2.39.0.windows.2
## 2. Configure your name and e-mail globally.
git config --global user.name "James G"
git config --global user.mail "jamesgnansia@hotmail.com"
...
## Look there for the option of the git config command that lists all Git configuration
git config --list
